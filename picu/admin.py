...
from .models import Picu, Patient, Admission,Culture,PositiveCulture,Diagnosis,AdmissionDiagnosis, SelectionType, SelectionValue
...
class AdmissionAdmin(admin.ModelAdmin):
	formfield_overrides = { models.ManyToManyField: {'widget': forms.SelectMultiple(attrs={'size':'3'})}, }
	fieldsets = [
        (None, {'fields': ['picu_admission_date', 'admitted_from', 'hospital_admission_date' ,'patient', 'admission_diagnosis','positive_cultures', 
...
class PatientAdmin(admin.ModelAdmin):
	...
	search_fields = ['first_name', 'second_name', 'gender']
